...
extension ClientExtension$Query$Search on graphql.GraphQLClient {
  ...
  void writeQuery$Search({
    ...
    bool broadcast = true,
      ...
      writeQuery(
        graphql.Request(
          operation: const graphql.Operation(document: documentNodeQuerySearch),
